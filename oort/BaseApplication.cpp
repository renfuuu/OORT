...
void BaseApplication::chooseSceneManager(void)
{
    ...
    mSceneMgr = mRoot->createSceneManager(Ogre::ST_GENERIC, "OgreAppSceneMgr");
	//Fix for 1.9
...
void BaseApplication::createFrameListener(void)
{
    ...
    //Simple Gui set up
    // scoreText = mTrayMgr->createTextBox(OgreBites::TL_BOTTOMRIGHT, "score", "Score", 100, 100);
    // livesText = mTrayMgr->createTextBox(OgreBites::TL_BOTTOMRIGHT, "lives", "Lives", 100, 100);
    mTrayMgr->hideCursor();
